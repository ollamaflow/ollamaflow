...
To use the link you just defined in your project, switch to the directory you want to use your Ollamaflow from, and run:

```shell
npm link ollamaflow-sdk
```
...
```javascript
import sdk from 'ollamaflow-sdk';
//or
var sdk = require('ollamaflow-sdk');
```
...
```javascript
var { OllamaflowSdk } = require('ollamaflow-sdk');

var api = new OllamaflowSdk(
