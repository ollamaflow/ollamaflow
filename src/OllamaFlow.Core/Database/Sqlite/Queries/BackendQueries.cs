    ...
    internal static class BackendQueries
    {
        ...
        internal static string Insert(Backend obj)
        {
            string ret =
                ...
                + "ratelimitthreshold, logrequestfull, logrequestbody, logresponsebody, apiformat, labels, "
                + "pinnedembeddingsprops, pinnedcompletionsprops, bearertoken, querystring, headers, "
                + "allowembeddings, allowcompletions, active, createdutc, lastupdateutc) "
                + "VALUES ("
                ...
                + "'" + Sanitizer.Sanitize(obj.LabelsString) + "',"
                + "'" + Sanitizer.Sanitize(obj.PinnedEmbeddingsPropertiesString) + "',"
                + "'" + Sanitizer.Sanitize(obj.PinnedCompletionsPropertiesString) + "',"
                + (obj.BearerToken != null ? "'" + Sanitizer.Sanitize(obj.BearerToken) + "'" : "NULL") + ","
                + (obj.Querystring != null ? "'" + Sanitizer.Sanitize(obj.Querystring) + "'" : "NULL") + ","
                + "'" + Sanitizer.Sanitize(obj.HeadersString) + "',"
                + (obj.AllowEmbeddings ? "1" : "0") + ","
                + (obj.AllowCompletions ? "1" : "0") + ","
                + (obj.Active ? "1" : "0") + ","
        ...
        internal static string Update(Backend obj)
        {
            return
                ...
                + "labels = '" + Sanitizer.Sanitize(obj.LabelsString) + "',"
                ...
                + "bearertoken = " + (obj.BearerToken != null ? "'" + Sanitizer.Sanitize(obj.BearerToken) + "'" : "NULL") + ","
                + "querystring = " + (obj.Querystring != null ? "'" + Sanitizer.Sanitize(obj.Querystring) + "'" : "NULL") + ","
                + "headers = '" + Sanitizer.Sanitize(obj.HeadersString) + "',"
